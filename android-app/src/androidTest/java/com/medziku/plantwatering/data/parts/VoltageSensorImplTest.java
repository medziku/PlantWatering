...
@SmallTest
public class VoltageSensorImplTest {
    ...
    public void parcelableWriteRead() {
        //given
        VoltageSensorImpl testee = new VoltageSensorImpl(TEST_STRING, TEST_FLOAT);
        ...
        assertThat(createdFromParcel.getVoltage(), is(TEST_FLOAT));
    }
}