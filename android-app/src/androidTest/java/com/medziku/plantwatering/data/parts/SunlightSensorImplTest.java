...
@SmallTest
public class SunlightSensorImplTest {
    ...
    public void parcelableWriteRead() {
        //given
        SunlightSensorImpl testee = new SunlightSensorImpl(TEST_STRING, TEST_FLOAT);
        ...
        assertThat(createdFromParcel.getSunlightLevel(), is(TEST_FLOAT));
    }
}